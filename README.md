# liza_web3
liza_web3 is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
You can liza_web3 Project via npm:

```bash
npm install liza_web3
```
## Usage

const Web3Tools = require('liza_web3');
